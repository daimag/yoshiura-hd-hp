...
const SCENES = [
  { img: "/img/funjin1.jpg", t: "粉じん飛散の抑制", d: "造成地、ストックヤード、仮設道路、解体現場など、粉じんの発生源となる裸地に散布。周辺環境への飛散を抑えます。" },
  { img: "/img/norimen.jpg", t: "法面・のり面の保護", d: "表層を固化して降雨時の表面侵食・崩落を抑制。緑化前の一次保護としても活用できます。" },
  { img: "/img/uretsu1.jpg", t: "雨裂（ガリ）侵食の防止", d: "盛土・切土の裸地表面を安定化し、雨水による雨裂の発生・拡大を防ぎます。" },
  { img: "/img/sokko.jpg", t: "素掘り側溝の補強", d: "側溝の表面を固めて崩れにくくし、通水機能の維持と維持管理の軽減に貢献します。" },
  { img: "/img/funjin2.jpg", t: "散布作業のようす", d: "散布車・噴霧器で簡単に施工。希釈濃度を調整して現場に合わせて対応します。" },
